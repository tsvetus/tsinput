...
const Column = (0, react_1.forwardRef)(({ className, style, layout = '', name, data, label, text, icon, wait, disabled, invalid, children, onClick, onTextClick, onIconClick }, ref) => {
    var _a, _b, _c, _d;
    ...
    const textComponent = labelText ? ((0, jsx_runtime_1.jsx)(Text_1.default, { className: textClasses, style: textStyles, name: name, data: data, value: labelText, wait: wait, disabled: disabled, invalid: invalid, onClick: handleTextClick })) : ((0, jsx_runtime_1.jsx)("div", {}));
    const iconComponent = icon ? ((0, jsx_runtime_1.jsx)(Icon_1.default, { className: classes.icon, style: styles.icon, name: name, data: data, icon: icon, wait: wait, disabled: disabled, invalid: invalid, onClick: handleIconClick })) : ((0, jsx_runtime_1.jsx)("div", {}));
